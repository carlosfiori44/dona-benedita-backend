...
prokey smallint(4) not null
)default charset = utf8;

ALTER TABLE categoria ADD
CONSTRAINT prokey FOREIGN KEY (id_produto) REFERENCES produto(id_produto);

create table fornecedor(
id_fornecedor smallint(3) not null,
nome_fornecedor varchar(40) not null,
cnpj int(14) not null
)default charset = utf8;

ALTER TABLE produto ADD
CONSTRAINT forkey FOREIGN KEY (id_fornecedor) REFERENCES fornecedor(id_fornecedor);
